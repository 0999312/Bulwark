...
| 横幅排版反馈 | done | `scenes/ui/hud.tscn`、`scenes/ui/hud.gd` | 横幅改为**内容自适应**（BannerTop(Margin) → Center → PanelContainer 包裹 VBox）：宽度随实际文本伸缩，标题 26px + 便签 16px 两行完整显示；1280 截图复核通过，不再固定 560 宽 |
