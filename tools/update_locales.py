...
STRUCT_ZH = {
    ...
    "hud.banner_chapter_lore": "{0} · 第 {1} 波\n{2}",
    "hud.wave_endless": "无尽 · 循环 {0} · 第 {1} 波",
    "menu.endless": "无尽模式",
    "menu.meta_progress": "战功 {0} · 下一个解锁：{1}",
    "menu.meta_all_unlocked": "战功 {0} · 起始武器已全部解锁",
    "result.score": "总分：{0}", "result.combo": "最高连击：{0}", "result.time": "用时：{0}s",
    "result.meta_gain": "获得战功 +{0}",
    "p2.chapter_reward_title": "章节奖励 · 三选一",
    "p2.chapter_reward_subtitle": "{0} 已镇压",
    "p2.chapter_reward_none": "暂无可用奖励",
    "lore.chapter.1": "前哨的防线还撑得住——但哨塔那边正在冒黑烟。",
    "lore.chapter.2": "小镇的残骸里传来响动：它们学会了用废墟挡子弹。",
    "lore.chapter.3": "污染区的油罐渗进了土壤，连怪物都沾着一身锈。",
    "lore.chapter.4": "巢穴就在前面。把灯关掉，别把它们引来。",
    ...
    "settings.key.aim": "瞄准",
    "settings.tab_game": "手感", "settings.sens_label": "鼠标灵敏度", "settings.shake_enabled": "启用震屏",
    "settings.shake_strength": "震屏强度", "settings.cursor_style": "准星样式", "settings.cursor_standard": "标准",
    "settings.cursor_hot": "热态", "settings.spread_visual": "显示散布扩散", "settings.key.reset_icon": "↺",
    "shop.price": "¥{0}",
...
STRUCT_EN = {
    ...
    "hud.banner_chapter_lore": "{0} · Wave {1}\n{2}",
    "hud.wave_endless": "Endless · Cycle {0} · Wave {1}",
    "menu.endless": "Endless Mode",
    "menu.meta_progress": "Glory {0} · Next unlock: {1}",
    "menu.meta_all_unlocked": "Glory {0} · All starting weapons unlocked",
    "result.score": "Total score: {0}", "result.combo": "Best combo: {0}", "result.time": "Time: {0}s",
    "result.meta_gain": "Glory earned +{0}",
    "p2.chapter_reward_title": "Chapter Reward · Pick One",
    "p2.chapter_reward_subtitle": "{0} suppressed",
    "p2.chapter_reward_none": "No rewards available",
    "lore.chapter.1": "The outpost line still holds—but the tower is smoking.",
    "lore.chapter.2": "Rustling from the ruins: they've learned to use debris as cover.",
    "lore.chapter.3": "Fuel tanks seeping into the soil; even the mutants rusted.",
    "lore.chapter.4": "The nest is ahead. Kill the lights. Don't draw them in.",
    ...
    "settings.tab_game": "Feel", "settings.sens_label": "Mouse Sensitivity", "settings.shake_enabled": "Enable Screen Shake",
    "settings.shake_strength": "Shake Strength", "settings.cursor_style": "Crosshair Style", "settings.cursor_standard": "Standard",
    "settings.cursor_hot": "Hot Bloom", "settings.spread_visual": "Show Spread Bloom", "settings.key.reset_icon": "↺",
    "shop.price": "¥{0}",
